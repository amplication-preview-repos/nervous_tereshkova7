...
import { ExtraInfoFindManyArgs } from "../../extraInfo/base/ExtraInfoFindManyArgs";
...
export class PropertyControllerBase {
  ...
  @common.Get("/:id/extraInfos")
  @ApiNestedQuery(ExtraInfoFindManyArgs)
  async findExtraInfos(
    @common.Req() request: Request,
    @common.Param() params: PropertyWhereUniqueInput
  ): Promise<ExtraInfo[]> {
    const query = plainToClass(ExtraInfoFindManyArgs, request.query);
    const results = await this.service.findExtraInfos(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/extraInfos")
  async connectExtraInfos(
    @common.Param() params: PropertyWhereUniqueInput,
    @common.Body() body: ExtraInfoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      extraInfos: {
        connect: body,
  ...
  @common.Patch("/:id/extraInfos")
  async updateExtraInfos(
    @common.Param() params: PropertyWhereUniqueInput,
    @common.Body() body: ExtraInfoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/extraInfos")
  async disconnectExtraInfos(
    @common.Param() params: PropertyWhereUniqueInput,
    @common.Body() body: ExtraInfoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
